...
var plotHeight;
  ...
  var y = d3.scaleLinear().domain([0,1.5]).range([height, 0]);
  ...
  var drawLine = d3.line()
    ...
    d3.csv("data/retailGeneralMerchandise.csv", type, function(error, data) {
      ...
      var svg = d3.select("#retailGeneralMerchandise").selectAll("svg")
          .data(sectors)
          .enter().append("svg")
